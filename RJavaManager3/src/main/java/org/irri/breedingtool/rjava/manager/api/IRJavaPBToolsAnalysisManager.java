...
public interface IRJavaPBToolsAnalysisManager {
	...
	public void doLinearReg(String dataFileName, String outputPath, String[] depvar,
			String[] indepvar, boolean constant, boolean confInt,
			double confLevel, boolean covMatrix, boolean VIF, boolean autoCorr,
			String[] heteroskedasticity, String[] normality, boolean COOKS,
			boolean leverage);
	...
	public void doSingleEnvironmentAnalysis2(String dataFileName, String outFileName,
			String resultFolderPath, int designIndex, String[] respvar,
			String environment, String[] environmentLevels, String genotype,
			String block, String rep, String row, String column,
			boolean descriptiveStat, boolean varianceComponents,
			boolean boxplotRawData, boolean histogramRawData,
			boolean heatmapResiduals, String heatmapRow, String heatmapColumn,
			boolean diagnosticPlot, boolean genotypeFixed,
			String pairwiseAlpha,
			String[] genotypeLevels, String[] controlLevels,
			boolean compareControl, boolean specifiedContrast, String contrastFileName,
			boolean genotypeRandom, boolean excludeControls,
			boolean genoPhenoCorrelation);


	void doMultiEnvironmentOneStage(String dataFileName,
			String outFileName, String resultFolderPath, int designIndex,
			String[] respvar, String environment, String[] environmentLevels,
			String genotype, String block, String rep, String row,
			String column, boolean descriptiveStat, boolean varianceComponents,
			boolean boxplotRawData, boolean histogramRawData,
			boolean diagnosticPlot, boolean genotypeFixed,
			boolean performPairwise, String pairwiseAlpha,
			String[] genotypeLevels, String[] controlLevels,
			boolean compareControl, boolean performAllPairwise,
			boolean genotypeRandom, boolean stabilityFinlay, boolean stabilityShukla, boolean specifiedContrastGeno, String contrastGenoFilename,
			boolean specifiedContrastEnv, String contrastEnvFilename, boolean ammi, boolean gge);


	void doOutlierDetection(String dataFileName, String outputPath,
			String respvar, String trmt, String rep);


	void doSingleEnvironmentAnalysisPRep(String dataFileName,
			String resultFolderPath, String[] respvar, String genotype,
			String row, String column, String environment,
			boolean genotypeFixed, boolean genotypeRandom, boolean excludeControls,
			String[] controlLevel, boolean moransTest, String[] spatialStruc,
			boolean descriptiveStat, boolean varianceComponents,
			boolean boxplotRawData, boolean histogramRawData,
