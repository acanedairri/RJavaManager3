...
public class TestMultiEnvironmentFirstStageDMAS {
	...
	public static void main(String[] args) {
		...
		String outFileName = DATA_PATH + "MEAFirstStageDMAS_output.txt";
...
//		boolean specifiedContrastGeno = true;
//		String contrastGenoFilename = DATA_PATH + "contrastMEOGeno_RCB_ME.csv";
...
//		String contrastGenoFilename = DATA_PATH + "contrastMEGeno.csv";
//		boolean specifiedContrastEnv = false; 
//		String contrastEnvFilename = null;
//		
//		boolean ammi = false;
...
//		boolean genotypeRandom = true;
		...
		rJavaManager.getPbToolAnalysisManager().doMultiEnvironmentOneStage(dataFileName, outFileName, resultFolderPath, designIndex, respvar, environment, environmentLevels,
				...
				genotypeFixed, performPairwise, pairwiseAlpha, genotypeLevels, controlLevels, compareControl, performAllPairwise, genotypeRandom, stabilityFinlay, 
				stabilityShukla, specifiedContrastGeno, contrastGenoFilename, specifiedContrastEnv, contrastEnvFilename, ammi, gge);
	}
