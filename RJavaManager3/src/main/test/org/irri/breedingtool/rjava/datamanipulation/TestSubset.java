...
public class TestSubset {
	...
	public static void main(String[] args) {
		...
		String dataFileName = DATA_PATH + "MET_blups_hetvar.csv";
		...
		subsetConditions.add("Stage:==:2:Numeric");
		subsetConditions.add("Module:==:2:Numeric");
		subsetConditions.add("Year:==:2012:Numeric");
